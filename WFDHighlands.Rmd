...
###GOF with parboot:
fitstats <- function(WFD.occu.11) {
  observed <- getY(WFD.occu.11@data)
  expected <- fitted(WFD.occu.11)
  resids <- residuals(WFD.occu.11)
...
pb <- parboot(WFD.occu.11, fitstats, nsim=10000, report=1)

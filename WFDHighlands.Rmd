...
#### Quadratic for tree variable does not improve model
```
...
<!--------------------Best model now 14 including covariates for detectability ------------------->
<!--------------------- AIC for model with no detectability covariates is slightly better but by < 1 ----------------->
<!--------- Adding detectability covariates seems to change the sign of the 'wet' predictors - this is weird and doesn't represent a biological relationship that we know about - is this a good justification for getting rid? ------------>
<!----------- Lost the plot.................... -------------->
